...
public class Skill : ScriptableObject
{
    ...
    protected float maxCd = 0.1f;          // cd maksimal
    ...
    {
        int index = GameManager.selectedSkills.FindIndex(skillPref => Name == skillPref.GetComponent<SkillController>().playerSkill.Name);
